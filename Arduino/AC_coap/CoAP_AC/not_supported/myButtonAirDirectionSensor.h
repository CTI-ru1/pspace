...
class myButtonAirDirectionSensor : public CoapSensor 
{
public:
  Toyotomi *toyo;
  myButtonAirDirectionSensor(String name, Toyotomi *toyotomi): CoapSensor(name)
  {
    this->toyo=toyotomi;
  }
